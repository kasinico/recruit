        ...
        <!-- =======================advert - ====================== -->
            ...
            <div class="card sidebar-alert shadow-none text-center mx-4 mb-0 mt-5">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <h5 class="alertcard-title font-size-16">ADS</h5>
                        <p class="font-size-13">Advert space’.</p>
                        <a href="#!" class="btn btn-primary mt-2">ADVERT Now</a>
                    </div>
                </div>
            </div>
        <!-- =======================advert-======================== -->
...
<!-- Left Sidebar End -->
<?php /**PATH /home/bposeats/laravel/Dason/recruit/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>